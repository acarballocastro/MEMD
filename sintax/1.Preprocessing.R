...
# Recordamos que los missings están concentrados en las variables "company" y "agent".
...
# Vista la alta correlación entre "previous_cancellations" y "previous_bookings_not_canceled", 
...
# que la variable "reservation_status" tiene la misma información que
...
ggplot(d.e, aes(x = arrival_date_day_of_month, fill = is_canceled, y = is_canceled)) + 
  ...
  ggtitle("Relación entre día y cancelaciones")+ 
  labs(y="Cancelaciones", x = "Día del mes")

# También eliminaremos "arrival_date_week_number", pues indica lo mismo que "arrival_date_day_of_month".


# Eliminamos las variables que habíamos dicho y renovamos los índices
